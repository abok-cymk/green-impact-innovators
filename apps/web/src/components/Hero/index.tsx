...
export function Hero() {
  ...
  return (
    <section id="hero" className="mx-auto px-4 text-center mb-20 lg:mb-10">
      ...
      <div className="flex items-center justify-center mb-20"><img src="/images/main-logo.webp" alt="Green Impact Innovators" className="object-cover --mix-blend-color-burn" width={300} height={300}/></div>
      <p
        className="
          mx-auto
          mt-6
